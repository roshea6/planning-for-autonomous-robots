...
class eightPuzzleSolver():
    ...
    def performValidMoves(self, valid_moves, i, j):
        ...
        for move in valid_moves:
            ...
            if puzzle_string in self.visited_node_configs:
                ...
                self.visited_node_configs.add(puzzle_string)
    ...
    def solvePuzzle(self, puzzle):
        ...
        self.visited_node_configs.add(self.getNodeID(self.current_node_state["puzzle_state"]))
